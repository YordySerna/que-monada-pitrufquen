/* ══════════════════════════════════════════════════════════════════
   ¡QUE MONADA! · Pitrufquen — demo 168
   JS clasico, un IIFE, sin dependencias.

   Sin JavaScript la pagina se lee entera: el viaje y las cuatro
   cartas estan escritos en el HTML. Lo unico que se pierde son las
   pompas, la espuma que respira y la transparencia de la cabecera.
   ══════════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var piezas = [];
  ['.portada', '.portada__texto', '.galeria__titulo', '.gal', '.combo__fluye', '.agua__cabecera', '.carta', '.cierre', '.dueno__cols']
